...
function App({ Component, pageProps }: AppProps) {
  ...
  return (
    <>
      <Head>
        {/* <--- CHANGED: Set the Browser Tab Name to WeTransfer */}
      ...
      >
        <MantineProvider
          ...
          theme={{ 
            colorScheme, 
            ...globalStyle,
            // <--- CHANGED: Force color to Blue (WeTransfer style) instead of Purple
            primaryColor: 'blue', 
          }}
        >
          <ColorSchemeProvider
                ...
                >
                  {excludeDefaultLayoutRoutes.includes(route) ? (
                    ...
                    <>
                      ...
                      >
                        <div>
                          {/* <--- NOTE: The Logo image is inside this Header component. 
                               To remove the image visually, you must replace the file in 
                               public/img/logo.svg with a transparent image or your own logo. */}
                          <Header />
                          <Container>
                            <Component {...pageProps} />
                          </Container>
