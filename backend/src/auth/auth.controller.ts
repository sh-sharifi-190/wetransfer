...
export class AuthController {
  ...
  @Post("signUp")
  @Throttle({ default: { limit: 20, ttl: 5 * 60 } })
  async signUp(
  ...
  // --- Reset Password Endpoints (Stubs, since Email is removed) ---
  ...
  async signOut(
    ...
    // We removed the Redirect URI return logic because OAuth is gone.
    ...
    // Explicitly return nothing/success
    return;
  }
